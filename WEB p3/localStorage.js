...
function addItemToCart(shopItem, marca, model, preu, imageSrc, cantitat) {
    ...
    <img name="img" id="img"class="cart-item-image" src="${imageSrc}" width="80" height="80">
    <span name="marca" id="marca" class="cart-item-marca">${marca}</span>
    <span name="model" id="model" class="cart-item-model">${model}</span>
</div>
<span name="preu" class="cart-preu cart-column">${preu}</span>
