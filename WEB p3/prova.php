...
$username = $password = $confirm_password = $nom = $cognom = $cognom2 = $dni = $email = $sexe ="";
$username_err = $password_err = $confirm_password_err = $nom_err = $cognom_err = $cognom2_err = $dni_err = $email_err = $sexe_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($nom_err) && empty($cognom_err) && empty($cognom2_err) && empty($dni_err) && empty($email_err) && empty($sexe_err)){
    ...
    }else if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($nom_err) && empty($cognom_err) && empty($cognom2_err) && empty($dni_err) && empty($email_err) && empty($sexe_err)){
